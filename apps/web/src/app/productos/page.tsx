...
const CATALOGO: Product[] = [
  ...
  { id: 'prod-beb-1',   name: 'Coca Cola 1.5L',     category_id: 'cat-bebidas',   unit: 'un', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80"]' },
  { id: 'prod-beb-2',   name: 'Fanta 1.5L',         category_id: 'cat-bebidas',   unit: 'un', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=600&q=80"]' },
