...
const CATALOGO: Product[] = [
  ...
  { id: 'prod-vac-004', name: 'Asado de Tira',      category_id: 'cat-vacuno',    unit: 'kg', base_price: 10000, online_price: 10000, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1633237308525-cd587cf71926?w=600&q=80"]' },
  { id: 'prod-vac-005', name: 'Entraña',            category_id: 'cat-vacuno',    unit: 'kg', base_price: 11990, online_price: 11990, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=600&q=80"]' },
  ...
  { id: 'prod-vac-007', name: 'Osobuco',            category_id: 'cat-vacuno',    unit: 'kg', base_price:  5990, online_price:  5990, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1615937691194-97dbd3f3dc29?w=600&q=80"]' },
  { id: 'prod-vac-008', name: 'Carne Molida',       category_id: 'cat-vacuno',    unit: 'kg', base_price: 10000, online_price: 10000, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1602470520998-f4a52199a3d6?w=600&q=80"]' },
  ...
  { id: 'prod-pol-003', name: 'Trutro de Pollo',    category_id: 'cat-pollo',     unit: 'kg', base_price:  3990, online_price:  3990, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=600&q=80"]' },
  { id: 'prod-emb-001', name: 'Longaniza Casera',   category_id: 'cat-embutidos', unit: 'un', base_price:  2990, online_price:  2990, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=600&q=80"]' },
  { id: 'prod-emb-002', name: 'Chorizo Parrillero', category_id: 'cat-embutidos', unit: 'un', base_price: 10000, online_price: 10000, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80"]' },
  { id: 'prod-emb-003', name: 'Prieta',             category_id: 'cat-embutidos', unit: 'un', base_price:  2490, online_price:  2490, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&q=80"]' },
  { id: 'prod-cor-001', name: 'Pierna de Cordero',  category_id: 'cat-parrilla',  unit: 'kg', base_price: 13990, online_price: 13990, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1615937722923-67f6deaf2cc9?w=600&q=80"]' },
  { id: 'prod-cor-002', name: 'Costillar Cordero',  category_id: 'cat-parrilla',  unit: 'kg', base_price: 11990, online_price: 11990, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&q=80"]' },
