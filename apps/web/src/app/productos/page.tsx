...
const CATALOGO: Product[] = [
  ...
  { id: 'prod-vac-003', name: 'Posta Negra',        category_id: 'cat-vacuno',    unit: 'kg', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&q=80"]' },
  { id: 'prod-vac-004', name: 'Asado de Tira',      category_id: 'cat-vacuno',    unit: 'kg', base_price: 100, online_price: 100, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1633237308525-cd587cf71926?w=600&q=80"]' },
  ...
  { id: 'prod-vac-006', name: 'Plateada',           category_id: 'cat-vacuno',    unit: 'kg', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=600&q=80"]' },
  ...
  { id: 'prod-cer-001', name: 'Pulpa de Cerdo',     category_id: 'cat-cerdo',     unit: 'kg', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1602470520998-f4a52199a3d6?w=600&q=80"]' },
  { id: 'prod-cer-002', name: 'Costillar de Cerdo', category_id: 'cat-cerdo',     unit: 'kg', base_price: 100, online_price: 100, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&q=80"]' },
  ...
  { id: 'prod-emb-001', name: 'Longaniza Casera',   category_id: 'cat-embutidos', unit: 'un', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=600&q=80"]' },
  { id: 'prod-emb-002', name: 'Chorizo Parrillero', category_id: 'cat-embutidos', unit: 'un', base_price: 100, online_price: 100, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80"]' },
  { id: 'prod-emb-003', name: 'Prieta',             category_id: 'cat-embutidos', unit: 'un', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&q=80"]' },
  ...
  { id: 'prod-cor-002', name: 'Costillar Cordero',  category_id: 'cat-parrilla',  unit: 'kg', base_price: 100, online_price: 100, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&q=80"]' },
  // ── Coca-Cola ──
  ...
  { id: 'beb-002', name: 'Coca-Cola Original Desechable 1,5 lt x6',    category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80"]' },
  { id: 'beb-003', name: 'Coca-Cola Original Lata 350 ml x6',          category_id: 'cat-bebidas', unit: 'un', base_price:  4416, online_price:  4416, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80"]' },
  { id: 'beb-004', name: 'Coca-Cola Zero Azúcar Desechable 2,5 lt',    category_id: 'cat-bebidas', unit: 'un', base_price: 12702, online_price: 12702, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1629203849820-f1f2a993e6d6?w=600&q=80"]' },
  { id: 'beb-005', name: 'Coca-Cola Zero Azúcar Desechable 1,5 lt x6', category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1629203849820-f1f2a993e6d6?w=600&q=80"]' },
  { id: 'beb-006', name: 'Coca-Cola Zero Azúcar Lata 350 ml x6',       category_id: 'cat-bebidas', unit: 'un', base_price:  4416, online_price:  4416, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1629203849820-f1f2a993e6d6?w=600&q=80"]' },
  // ── Fanta ──
  { id: 'beb-007', name: 'Fanta Naranja Desechable 2,5 lt x6',         category_id: 'cat-bebidas', unit: 'un', base_price: 12702, online_price: 12702, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1624552184280-9e9631bbeee9?w=600&q=80"]' },
  { id: 'beb-008', name: 'Fanta Naranja Desechable 1,5 lt x6',         category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1624552184280-9e9631bbeee9?w=600&q=80"]' },
  { id: 'beb-009', name: 'Fanta Naranja Lata 350 ml x6',               category_id: 'cat-bebidas', unit: 'un', base_price:  4415, online_price:  4415, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1624552184280-9e9631bbeee9?w=600&q=80"]' },
  // ── Sprite ──
  { id: 'beb-010', name: 'Sprite Desechable 2,5 lt x6',                category_id: 'cat-bebidas', unit: 'un', base_price: 12702, online_price: 12702, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=600&q=80"]' },
  { id: 'beb-011', name: 'Sprite Desechable 1,5 lt x6',                category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=600&q=80"]' },
  { id: 'beb-012', name: 'Sprite Lata 350 ml x6',                      category_id: 'cat-bebidas', unit: 'un', base_price:  4416, online_price:  4416, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=600&q=80"]' },
  // ── Monster ──
  { id: 'beb-013', name: 'Monster Energy 473 ml x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80"]' },
  { id: 'beb-014', name: 'Monster Energy Zero Sugar 473 ml x6',        category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80"]' },
  { id: 'beb-015', name: 'Monster Ultra 473 ml x6',                    category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80"]' },
  { id: 'beb-016', name: 'Monster Ripper 473 ml x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80"]' },
  { id: 'beb-017', name: 'Monster Pipeline Punch 473 ml x6',           category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1622543925917-763c34d1a86e?w=600&q=80"]' },
  // ── Benedictino ──
  { id: 'beb-018', name: 'Benedictino Con Gas 500 ml x12',             category_id: 'cat-bebidas', unit: 'un', base_price:  6601, online_price:  6601, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1559839914-17aae19cec71?w=600&q=80"]' },
  { id: 'beb-019', name: 'Benedictino Sin Gas 500 ml x12',             category_id: 'cat-bebidas', unit: 'un', base_price:  6601, online_price:  6601, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1559839914-17aae19cec71?w=600&q=80"]' },
  { id: 'beb-020', name: 'Benedictino Con Gas 1,5 lt x6',             category_id: 'cat-bebidas', unit: 'un', base_price:  4644, online_price:  4644, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1559839914-17aae19cec71?w=600&q=80"]' },
  { id: 'beb-021', name: 'Benedictino Sin Gas 1,5 lt x6',             category_id: 'cat-bebidas', unit: 'un', base_price:  4644, online_price:  4644, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1559839914-17aae19cec71?w=600&q=80"]' },
  // ── Aquarius ──
  { id: 'beb-022', name: 'Aquarius Uva 1,6 lt x6',                    category_id: 'cat-bebidas', unit: 'un', base_price:  5251, online_price:  5251, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-023', name: 'Aquarius Pera 1,6 lt x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  5251, online_price:  5251, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-024', name: 'Aquarius Manzana 1,6 lt x6',                category_id: 'cat-bebidas', unit: 'un', base_price:  5251, online_price:  5251, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-025', name: 'Aquarius Uva 500 ml x6',                    category_id: 'cat-bebidas', unit: 'un', base_price:  3785, online_price:  3785, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-026', name: 'Aquarius Pera 500 ml x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  3785, online_price:  3785, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-027', name: 'Aquarius Manzana 500 ml x6',                category_id: 'cat-bebidas', unit: 'un', base_price:  3785, online_price:  3785, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  // ── Del Valle ──
  { id: 'beb-028', name: 'Del Valle Durazno 1,5 lt x6',               category_id: 'cat-bebidas', unit: 'un', base_price:  7736, online_price:  7736, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1534353436294-0dbd4bdac845?w=600&q=80"]' },
  { id: 'beb-029', name: 'Del Valle Naranja 1,75 lt x6',              category_id: 'cat-bebidas', unit: 'un', base_price:  6948, online_price:  6948, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1534353436294-0dbd4bdac845?w=600&q=80"]' },
