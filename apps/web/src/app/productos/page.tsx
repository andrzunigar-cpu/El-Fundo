...
const CATALOGO: Product[] = [
  ...
  { id: 'beb-003', name: 'Coca-Cola Original Lata 350 ml x6',          category_id: 'cat-bebidas', unit: 'un', base_price:  4416, online_price:  4416, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=600&q=80"]' },
  ...
  { id: 'beb-005', name: 'Coca-Cola Zero Azúcar Desechable 1,5 lt x6', category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&q=80"]' },
  { id: 'beb-006', name: 'Coca-Cola Zero Azúcar Lata 350 ml x6',       category_id: 'cat-bebidas', unit: 'un', base_price:  4416, online_price:  4416, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=600&q=80"]' },
  // ── Fanta ──
  { id: 'beb-007', name: 'Fanta Naranja Desechable 2,5 lt x6',         category_id: 'cat-bebidas', unit: 'un', base_price: 12702, online_price: 12702, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1569529465828-f66efbcef9c6?w=600&q=80"]' },
  { id: 'beb-008', name: 'Fanta Naranja Desechable 1,5 lt x6',         category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1569529465828-f66efbcef9c6?w=600&q=80"]' },
  { id: 'beb-009', name: 'Fanta Naranja Lata 350 ml x6',               category_id: 'cat-bebidas', unit: 'un', base_price:  4415, online_price:  4415, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1569529465828-f66efbcef9c6?w=600&q=80"]' },
  // ── Sprite ──
  { id: 'beb-010', name: 'Sprite Desechable 2,5 lt x6',                category_id: 'cat-bebidas', unit: 'un', base_price: 12702, online_price: 12702, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1567620905732-2d1998f7d02d?w=600&q=80"]' },
  { id: 'beb-011', name: 'Sprite Desechable 1,5 lt x6',                category_id: 'cat-bebidas', unit: 'un', base_price:  9614, online_price:  9614, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1567620905732-2d1998f7d02d?w=600&q=80"]' },
  ...
  // ── Monster ──
  { id: 'beb-013', name: 'Monster Energy 473 ml x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: true,  status: 'active', image_urls: '["https://images.unsplash.com/photo-1630358854434-6c1ca31de37d?w=600&q=80"]' },
  { id: 'beb-014', name: 'Monster Energy Zero Sugar 473 ml x6',        category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1630358854434-6c1ca31de37d?w=600&q=80"]' },
  { id: 'beb-015', name: 'Monster Ultra 473 ml x6',                    category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1630358854434-6c1ca31de37d?w=600&q=80"]' },
  { id: 'beb-016', name: 'Monster Ripper 473 ml x6',                   category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1630358854434-6c1ca31de37d?w=600&q=80"]' },
  { id: 'beb-017', name: 'Monster Pipeline Punch 473 ml x6',           category_id: 'cat-bebidas', unit: 'un', base_price:  9295, online_price:  9295, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1630358854434-6c1ca31de37d?w=600&q=80"]' },
  // ── Benedictino ──
  { id: 'beb-018', name: 'Benedictino Con Gas 500 ml x12',             category_id: 'cat-bebidas', unit: 'un', base_price:  6601, online_price:  6601, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80"]' },
  { id: 'beb-019', name: 'Benedictino Sin Gas 500 ml x12',             category_id: 'cat-bebidas', unit: 'un', base_price:  6601, online_price:  6601, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80"]' },
  { id: 'beb-020', name: 'Benedictino Con Gas 1,5 lt x6',             category_id: 'cat-bebidas', unit: 'un', base_price:  4644, online_price:  4644, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80"]' },
  { id: 'beb-021', name: 'Benedictino Sin Gas 1,5 lt x6',             category_id: 'cat-bebidas', unit: 'un', base_price:  4644, online_price:  4644, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&q=80"]' },
  // ── Aquarius ──
  ...
  // ── Del Valle ──
  { id: 'beb-028', name: 'Del Valle Durazno 1,5 lt x6',               category_id: 'cat-bebidas', unit: 'un', base_price:  7736, online_price:  7736, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
  { id: 'beb-029', name: 'Del Valle Naranja 1,75 lt x6',              category_id: 'cat-bebidas', unit: 'un', base_price:  6948, online_price:  6948, is_featured: false, status: 'active', image_urls: '["https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=600&q=80"]' },
